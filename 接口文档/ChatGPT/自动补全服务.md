---
title: "OpenAI-Hub API 文档 - 自动补全服务"
meta:
  - name: keywords
    content: "OpenAI-Hub API, 自动补全, API 文档, GPT-3.5模型, API 请求参数, API 返回结果"
  - name: description
    content: "本文档详细介绍了OpenAI-Hub提供的自动补全服务API，包括创建文本补全的方法，请求参数，和返回结果。涉及使用GPT-3.5模型进行文本补全的详细指南。"
---
